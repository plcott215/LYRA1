...
const firebaseConfig = {
  ...
  authDomain: import.meta.env.VITE_FIREBASE_PROJECT_ID ? `${import.meta.env.VITE_FIREBASE_PROJECT_ID}.firebaseapp.com` : '',
  projectId: import.meta.env.VITE_FIREBASE_PROJECT_ID || '',
  storageBucket: import.meta.env.VITE_FIREBASE_PROJECT_ID ? `${import.meta.env.VITE_FIREBASE_PROJECT_ID}.appspot.com` : '',
  appId: import.meta.env.VITE_FIREBASE_APP_ID || '',
  
  // Required by Firebase SDK
  messagingSenderId: '123456789', // Default value when not provided
};
